...
const HARDWARE = [
  { title: "Laptops",    icon: Laptop,   img: "https://images.unsplash.com/photo-1496181133206-80ce9b88a853?auto=format&fit=crop&q=80&w=200"   },
  { title: "PCs Gamer",  icon: Gamepad2, img: "https://images.unsplash.com/photo-1587202377425-8b90ed50a306?auto=format&fit=crop&q=80&w=200" },
  { title: "SSD / RAM",  icon: Cpu,      img: "https://images.unsplash.com/photo-1591799264318-7e6ef8ddb7ea?auto=format&fit=crop&q=80&w=200" },
  { title: "Monitores",  icon: Monitor,  img: "https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?auto=format&fit=crop&q=80&w=200"  },
];
