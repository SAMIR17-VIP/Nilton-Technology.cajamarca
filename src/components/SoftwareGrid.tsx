...
const SOFTWARE_SERVICES = [
  {
    ...
    icon: Monitor,
    img: `${import.meta.env.BASE_URL}images/software/office.png`,
  ...
  },
  {
    ...
    icon: Settings,
    img: `${import.meta.env.BASE_URL}images/software/windows.png`,
  ...
  },
  {
    ...
    icon: Cpu,
    img: `${import.meta.env.BASE_URL}images/software/drivers.png`,
  ...
  },
  {
    ...
    icon: Key,
    img: `${import.meta.env.BASE_URL}images/software/activations.png`,
  ...
  },
  {
    ...
    icon: Wrench,
    img: `${import.meta.env.BASE_URL}images/software/optimization.png`,
  ...
  },
  {
    ...
    icon: Layers,
    img: `${import.meta.env.BASE_URL}images/software/engineering.png`,
  ...
  },
  {
    ...
    icon: PenTool,
    img: `${import.meta.env.BASE_URL}images/software/design.png`,
  ...
  },
  {
    ...
    icon: ShieldCheck,
    img: `${import.meta.env.BASE_URL}images/software/remote.png`,
